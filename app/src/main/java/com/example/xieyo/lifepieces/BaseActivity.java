...
public class BaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        SpeechUtility.createUtility(BaseActivity.this, "appid=" + getString(R.string.app_id));

        super.onCreate(savedInstanceState);
        ActivityCollector.addActivity(this);
        Bmob.initialize(this, "e4f4f8831443adebf14e1784745e0d46");
        initPremission();


        String classPath = getApplicationContext().getFilesDir().getPath() + "/TimeExp.m";
        ...
        try {
                TimeNormalizer.writeModel(p, classPath);
            } catch (Exception e) {
                e.printStackTrace();
            }
