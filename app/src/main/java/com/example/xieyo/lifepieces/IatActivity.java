...
import com.example.xieyo.lifepieces.util.FucUtil;
...
public class IatActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mIat = com.iflytek.cloud.SpeechRecognizer.createRecognizer(IatActivity.this, mInitListener);
    ...
    private void initLayout() {
        ...
        findViewById(R.id.iat_recognize_stream).setOnClickListener(IatActivity.this);
        findViewById(R.id.iat_upload_contacts).setOnClickListener(IatActivity.this);
        findViewById(R.id.iat_upload_userwords).setOnClickListener(IatActivity.this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.iat_upload_contacts:
                ...
                ContactManager mgr = ContactManager.createManager(IatActivity.this,
                        mContactListener);
            ...
            case R.id.iat_upload_userwords:
                ...
                String contents = FucUtil.readFile(IatActivity.this, "userwords","utf-8");
